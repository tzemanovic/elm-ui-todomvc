...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cq: 'hidden', ad: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cq: 'mozHidden', ad: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cq: 'msHidden', ad: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cq: 'webkitHidden', ad: 'webkitvisibilitychange' }
		: { cq: 'hidden', ad: 'visibilitychange' };
}
...
var author$project$Main$emptyModel = {a: _List_Nil, t: '', R: 0, S: 'All'};
...
var author$project$Main$newEntry = F2(
	function (desc, id) {
		return {g: false, J: desc, U: false, f: id};
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ba: fragment, be: host, bq: path, bt: port_, bw: protocol, bx: query};
	});
			...
			case 4:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							a: elm$core$String$isEmpty(model.t) ? model.a : _Utils_ap(
								model.a,
								_List_fromArray(
									[
										A2(author$project$Main$newEntry, model.t, model.R)
									])),
							t: '',
							R: model.R + 1
						}),
...
var author$project$Main$fontSmoothing = function (val) {
	return _List_fromArray(
		[
			mdgriffith$elm_ui$Element$htmlAttribute(
			A2(elm$html$Html$Attributes$style, '-webkit-font-smoothing', val)),
			mdgriffith$elm_ui$Element$htmlAttribute(
			A2(elm$html$Html$Attributes$style, '-moz-font-smoothing', val)),
			mdgriffith$elm_ui$Element$htmlAttribute(
			A2(elm$html$Html$Attributes$style, 'font-smoothing', val))
		]);
};
var author$project$Main$fontAntialiased = author$project$Main$fontSmoothing('antialiased');
var mdgriffith$elm_ui$Internal$Model$Rgba = F4(
	function (a, b, c, d) {
		return {$: 0, a: a, b: b, c: c, d: d};
	});
var mdgriffith$elm_ui$Element$rgba = mdgriffith$elm_ui$Internal$Model$Rgba;
var author$project$Main$colorTransparent = A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0);
var author$project$Main$edges = {q: 0, af: 0, ah: 0, E: 0};
...
var mdgriffith$elm_ui$Internal$Style$classes = {bM: 'a', aF: 'atv', bO: 'ab', bP: 'cx', bQ: 'cy', bR: 'acb', bS: 'accx', bT: 'accy', bU: 'acr', a2: 'al', a3: 'ar', bV: 'at', aG: 'ah', aH: 'av', bX: 's', b$: 'bh', b0: 'b', b2: 'w7', b4: 'bd', b5: 'bdt', ao: 'bn', b6: 'bs', ap: 'cpe', cb: 'cp', cc: 'cpx', cd: 'cpy', z: 'c', ar: 'ctr', as: 'cb', at: 'ccx', A: 'ccy', ae: 'cl', au: 'cr', cf: 'ct', cg: 'cptr', ch: 'ctxt', cn: 'fcs', co: 'fs', cp: 'g', aN: 'hbh', aw: 'hc', aO: 'hf', bd: 'hfp', cr: 'hv', ct: 'ic', cv: 'fr', cx: 'iml', cy: 'it', cz: 'i', X: 'nb', bk: 'notxt', cD: 'ol', cE: 'or', O: 'oq', cI: 'oh', bo: 'pg', bp: 'p', cJ: 'ppe', cL: 'ui', o: 'r', cN: 'sb', cO: 'sbx', cP: 'sby', cQ: 'sbt', cS: 'e', cT: 'cap', cU: 'sev', c_: 'sk', bE: 't', c1: 'tc', c2: 'w8', c3: 'w2', c4: 'w9', c5: 'tj', aC: 'tja', c6: 'tl', c7: 'w3', c8: 'w5', c9: 'w4', da: 'tr', db: 'w6', dc: 'w1', dd: 'tun', bF: 'ts', Q: 'clr', di: 'u', a_: 'wc', bJ: 'we', a$: 'wf', bK: 'wfp', a0: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + mdgriffith$elm_ui$Internal$Style$classes.z);
...
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bo);
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bp);
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + mdgriffith$elm_ui$Internal$Style$classes.o);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cS);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.r)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.cV.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.cV.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.o) + ('-' + (elm$core$String$fromInt(pos.ce) + ('-' + (elm$core$String$fromInt(pos.ab) + ('-' + elm$core$String$fromInt(pos.W)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.aR.a) + 'px'),
					elm$core$Maybe$Just(
					elm$core$String$fromFloat(shadow.aR.b) + 'px'),
					elm$core$Maybe$Just(
							...
							mdgriffith$elm_ui$Internal$Model$formatBoxShadow(
								{
									...
									aR: A2(
										...
										A2(elm$core$Tuple$mapFirst, elm$core$Basics$toFloat, shadow.aR)),
									aW: shadow.aW
								}));
					},
					focus.cR),
	...
	[
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.cr, mdgriffith$elm_ui$Internal$Style$classes.O)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.cn, mdgriffith$elm_ui$Internal$Style$classes.O)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.aF, mdgriffith$elm_ui$Internal$Style$classes.Q)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bX) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.o) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bX) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bX) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.o) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bX) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.ar) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
...
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {aq: closing, h: _List_Nil, D: _List_Nil, w: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								h: A2(
									elm$core$List$cons,
									{aq: '\n}', h: _List_Nil, D: props, w: '@supports (' + (prop + (':' + (value + (') {' + parent.w))))},
									rendered.h)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.w + ('{' + (renderValues(rule.D) + (rule.aq + '}')));
		}
	};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.cT + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.bE + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.cT + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.bE)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {W: height / size, aW: size, bH: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.b9, adjustment.b_, adjustment.ci, adjustment.cA]);
	var lineHeight = 1.5;
				...
				switch (rule.$) {
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.o) + (' / ' + (elm$core$String$fromInt(position.o + position.W) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.ce) + (' / ' + (elm$core$String$fromInt(position.ce + position.ab) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.o) + ('-' + (elm$core$String$fromInt(position.ce) + ('-' + (elm$core$String$fromInt(position.ab) + ('-' + elm$core$String$fromInt(position.W)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.bX + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cS))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.bX, mdgriffith$elm_ui$Internal$Style$classes.cS, mdgriffith$elm_ui$Internal$Style$classes.ar, mdgriffith$elm_ui$Internal$Style$classes.A, mdgriffith$elm_ui$Internal$Style$classes.bU])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.bX, mdgriffith$elm_ui$Internal$Style$classes.cS, mdgriffith$elm_ui$Internal$Style$classes.ar, mdgriffith$elm_ui$Internal$Style$classes.A, mdgriffith$elm_ui$Internal$Style$classes.bS])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.bX, mdgriffith$elm_ui$Internal$Style$classes.cS, mdgriffith$elm_ui$Internal$Style$classes.ar, mdgriffith$elm_ui$Internal$Style$classes.bT])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.bX, mdgriffith$elm_ui$Internal$Style$classes.cS, mdgriffith$elm_ui$Internal$Style$classes.ar, mdgriffith$elm_ui$Internal$Style$classes.bR])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.bX, mdgriffith$elm_ui$Internal$Style$classes.bE, mdgriffith$elm_ui$Internal$Style$classes.a_, mdgriffith$elm_ui$Internal$Style$classes.aw])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.bX, mdgriffith$elm_ui$Internal$Style$classes.bE, mdgriffith$elm_ui$Internal$Style$classes.a$, mdgriffith$elm_ui$Internal$Style$classes.aO])))
			]),
		_List_fromArray(
			[
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cS, mdgriffith$elm_ui$Internal$Style$classes.bM]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cS, mdgriffith$elm_ui$Internal$Style$classes.b0]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cS, mdgriffith$elm_ui$Internal$Style$classes.cE]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
							...
							case 4:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cS, mdgriffith$elm_ui$Internal$Style$classes.cv]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.X, mdgriffith$elm_ui$Internal$Style$classes.cS, mdgriffith$elm_ui$Internal$Style$classes.b$]));
						}
					}())
				]),
			_List_fromArray(
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aG + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bP);
	}
};
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		...
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.aH + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bO);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.aH + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bQ);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						mdgriffith$elm_ui$Internal$Style$classes.bX + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.o + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.bd + (' height-fill-' + elm$core$String$fromInt(portion)))),
											...
											A3(
												mdgriffith$elm_ui$Internal$Model$Single,
												mdgriffith$elm_ui$Internal$Style$classes.bX + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.z + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + elm$core$String$fromInt(portion))))),
												'flex-grow',
												elm$core$String$fromInt(portion * 100000)),
											styles),
...
var mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.cf + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ae)),
				A2(
					elm$core$List$cons,
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								elm$core$List$cons,
								mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.at + (' ' + mdgriffith$elm_ui$Internal$Style$classes.A)),
								attrs))))),
			mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var mdgriffith$elm_ui$Element$Font$center = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontAlignment, mdgriffith$elm_ui$Internal$Style$classes.c1);
...
var author$project$Main$infoFooter = A2(
	...
	_List_fromArray(
		[
			...
			A3(mdgriffith$elm_ui$Element$rgb255, 191, 191, 191)),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Double-click to edit a todo')
				])),
			A2(
			mdgriffith$elm_ui$Element$paragraph,
			_List_Nil,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Written by '),
					A2(
					...
					_List_fromArray(
						[
							...
							_Utils_update(
								...
								{q: 1})),
							mdgriffith$elm_ui$Element$Border$color(author$project$Main$colorTransparent),
							mdgriffith$elm_ui$Element$mouseOver(
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Border$color(
									A4(mdgriffith$elm_ui$Element$rgba255, 119, 119, 119, 0.5))
								]))
						]),
					{
						u: mdgriffith$elm_ui$Element$text('Tomáš Zemanovič'),
						aZ: 'https://github.com/tzemanovic'
					})
				])),
			A2(
			mdgriffith$elm_ui$Element$paragraph,
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$text('Part of '),
					A2(
					mdgriffith$elm_ui$Element$link,
					_List_fromArray(
						[
					...
					{
						u: mdgriffith$elm_ui$Element$text('TodoMVC'),
						aZ: 'http://todomvc.com'
					})
				]))
		]));
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						elm$core$List$cons,
						mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.at + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.A + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.cQ + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bk)))))),
						A2(
							elm$core$List$cons,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$transparent(!entriesCompleted),
				mdgriffith$elm_ui$Element$Border$widthEach(
				_Utils_update(
					author$project$Main$edges,
					{q: 1})),
		...
		{
			u: mdgriffith$elm_ui$Element$text(
				'Clear completed (' + (elm$core$String$fromInt(entriesCompleted) + ')')),
			bl: elm$core$Maybe$Just(author$project$Main$DeleteComplete)
		});
};
...
var author$project$Main$viewControlsCount = function (entriesLeft) {
	...
	return A2(
		...
		mdgriffith$elm_ui$Element$text(
			elm$core$String$fromInt(entriesLeft) + (item_ + ' left')));
};
...
var mdgriffith$elm_ui$Element$Border$solid = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$borderStyle, mdgriffith$elm_ui$Internal$Style$classes.b6);
						...
						[
							...
							[
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Element$Border$color(
										A4(mdgriffith$elm_ui$Element$rgba255, 175, 47, 47, 0.1))
									]))
							]),
							_Utils_eq(visibility, actualVisibility) ? _List_fromArray(
							[
								mdgriffith$elm_ui$Element$Border$color(
								A4(mdgriffith$elm_ui$Element$rgba255, 175, 47, 47, 0.2))
							]) : _List_Nil
						])),
				{
					u: mdgriffith$elm_ui$Element$text(visibility),
					aZ: uri
				}));
	});
		...
		case 1:
			...
			return styled.cs(
				A2(
					...
					{
						cn: {bZ: elm$core$Maybe$Nothing, b3: elm$core$Maybe$Nothing, cR: elm$core$Maybe$Nothing},
						cr: 1,
						cB: 1
					},
					styled.c$));
...
var author$project$Main$viewControls = F2(
	function (visibility, entries) {
		var evenWidth = mdgriffith$elm_ui$Element$el(
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
				]));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Font$color(
					A3(mdgriffith$elm_ui$Element$rgb255, 119, 119, 119)),
					mdgriffith$elm_ui$Element$Font$center,
					mdgriffith$elm_ui$Element$Border$solid,
					mdgriffith$elm_ui$Element$Border$widthEach(
					_Utils_update(
					...
					mdgriffith$elm_ui$Element$htmlAttribute(
					A2(elm$html$Html$Attributes$style, 'box-shadow', '0 1px 1px rgba(0, 0, 0, 0.2), 0 8px 0 -3px #f6f6f6, 0 9px 1px -3px rgba(0, 0, 0, 0.2), 0 16px 0 -6px #f6f6f6, 0 17px 2px -6px rgba(0, 0, 0, 0.2)'))
				]),
			_List_fromArray(
				[
					evenWidth(
					A2(mdgriffith$elm_ui$Element$Lazy$lazy, author$project$Main$viewControlsCount, entriesLeft)),
					evenWidth(
					A2(mdgriffith$elm_ui$Element$Lazy$lazy, author$project$Main$viewControlsFilters, visibility)),
					evenWidth(
					A2(mdgriffith$elm_ui$Element$Lazy$lazy, author$project$Main$viewControlsClear, entriesCompleted))
				]));
	});
...
var author$project$Main$checkCompleteSrc = 'data:image/svg+xml;utf8,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2240%22%20height%3D%2240%22%20viewBox%3D%22-10%20-18%20100%20135%22%3E%3Ccircle%20cx%3D%2250%22%20cy%3D%2250%22%20r%3D%2250%22%20fill%3D%22none%22%20stroke%3D%22%23bddad5%22%20stroke-width%3D%223%22/%3E%3Cpath%20fill%3D%22%235dc2af%22%20d%3D%22M72%2025L42%2071%2027%2056l-4%204%2020%2020%2034-52z%22/%3E%3C/svg%3E';
var author$project$Main$checkIncompleteSrc = 'data:image/svg+xml;utf8,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%2240%22%20height%3D%2240%22%20viewBox%3D%22-10%20-18%20100%20135%22%3E%3Ccircle%20cx%3D%2250%22%20cy%3D%2250%22%20r%3D%2250%22%20fill%3D%22none%22%20stroke%3D%22%23ededed%22%20stroke-width%3D%223%22/%3E%3C/svg%3E';
	...
	return elm$core$String$concat(
		_List_fromArray(
			[
				...
				elm$core$String$fromFloat(shadow.aK) + 'px',
				elm$core$String$fromFloat(shadow.aW) + 'px',
				mdgriffith$elm_ui$Internal$Model$formatColorClass(shadow.aL)
			]));
};
var mdgriffith$elm_ui$Element$Border$innerShadow = function (almostShade) {
	var shade = {aK: almostShade.aK, aL: almostShade.aL, bg: true, aR: almostShade.aR, aW: almostShade.aW};
	return A2(
		mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var author$project$Main$todoInputStyles = elm$core$List$concat(
	_List_fromArray(
		[
			_List_fromArray(
			[
				...
				A4(mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 3.0e-3)),
				mdgriffith$elm_ui$Element$Border$innerShadow(
				{
					aK: 1,
					aL: A4(mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 3.0e-2),
					aR: _Utils_Tuple2(0, -2),
					aW: 0
				})
			]),
			author$project$Main$fontAntialiased
		]));
...
var mdgriffith$elm_ui$Element$Font$italic = mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.cz);
var mdgriffith$elm_ui$Element$Font$strike = mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.c_);
...
var mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var behavior = _List_fromArray(
			[
				mdgriffith$elm_ui$Internal$Model$Attr(
				elm$html$Html$Events$onInput(textOptions.aA))
			]);
			...
			if (!_n1.$) {
				...
				return _Utils_Tuple3(
					...
					_Utils_ap(
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Input$value(textOptions.bE),
								mdgriffith$elm_ui$Internal$Model$Attr(
				...
				var _n3 = A3(
					...
					{j: _List_Nil, aw: elm$core$Maybe$Nothing, ax: elm$core$Maybe$Nothing, ay: elm$core$Maybe$Nothing, az: elm$core$Maybe$Nothing},
					attributes);
				var maybePadding = _n3.ay;
				var heightContent = _n3.aw;
				var maybeSpacing = _n3.az;
				var adjustedAttributes = _n3.j;
				var maybeBorder = _n3.ax;
				...
				return _Utils_Tuple3(
							...
							[
								...
								if (maybePadding.$ === 1) {
									...
									return mdgriffith$elm_ui$Element$paddingEach(
										{
											q: A2(elm$core$Basics$max, 0, b - ((spacing / 2) | 0)),
											af: l,
											ah: r,
											E: A2(elm$core$Basics$max, 0, t - ((spacing / 2) | 0))
										});
								}
							}(),
								function () {
								if (heightContent.$ === 1) {
									...
									if (heightContent.a) {
										return A4(mdgriffith$elm_ui$Element$Input$textHeightContent, textOptions.bE, spacing, maybePadding, maybeBorder);
									} else {
										return mdgriffith$elm_ui$Internal$Model$NoAttribute;
									}
								}
					...
					_List_fromArray(
						[
							...
							elm$html$Html$text(textOptions.bE))
						]));
			}
		}();
		var inputNode = _n0.a;
													...
													_Utils_ap(
														_List_fromArray(
															[
																...
																mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.bk + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cJ)),
																mdgriffith$elm_ui$Element$Border$color(
			...
			_List_fromArray(
				[
					...
					[
						...
						_Utils_update(
							author$project$Main$edges,
							{q: 17, af: 15, ah: 60, E: 17})),
						mdgriffith$elm_ui$Element$htmlAttribute(
						elm$html$Html$Attributes$class('todo-entry')),
						mdgriffith$elm_ui$Element$htmlAttribute(
						A2(elm$html$Html$Attributes$style, 'transition', 'color 0.4s')),
						mdgriffith$elm_ui$Element$htmlAttribute(
								...
								[
									...
									_List_fromArray(
										[
											...
											mdgriffith$elm_ui$Element$Font$color(
											A3(mdgriffith$elm_ui$Element$rgb255, 204, 154, 154)),
											mdgriffith$elm_ui$Element$mouseOver(
											_List_fromArray(
												[
													mdgriffith$elm_ui$Element$Font$color(
													A3(mdgriffith$elm_ui$Element$rgb255, 175, 91, 94))
												]))
										]),
									{
										u: A2(
					...
					todo.g ? _List_fromArray(
					[
						mdgriffith$elm_ui$Element$Font$strike,
						mdgriffith$elm_ui$Element$Font$color(
						A3(mdgriffith$elm_ui$Element$rgb255, 217, 217, 217))
					]) : _List_Nil
				])),
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$text(todo.J)
			]));
	var viewEditing = A2(
				...
				[
					...
					[
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$Border$color(
								A3(mdgriffith$elm_ui$Element$rgb255, 153, 153, 153)),
								mdgriffith$elm_ui$Element$Border$innerShadow(
								{
									aK: 5,
									aL: A4(mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 0.2),
									aR: _Utils_Tuple2(0, -1),
									aW: 0
								})
							]))
					]),
					author$project$Main$todoInputStyles
				])),
		{
			u: mdgriffith$elm_ui$Element$Input$labelHidden('What needs to be done?'),
			aA: author$project$Main$UpdateEntry(todo.f),
				...
				A2(
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$Font$color(
							A4(mdgriffith$elm_ui$Element$rgba255, 230, 230, 230, 0.5))
						]),
					mdgriffith$elm_ui$Element$text('What needs to be done?'))),
			bE: todo.J
		});
	var viewCompleteCheckbox = A2(
		...
		_List_fromArray(
			[
				...
				todo.g ? author$project$Main$checkCompleteSrc : author$project$Main$checkIncompleteSrc)
			]),
		{
			a5: todo.g,
			bf: elm$core$Basics$always(
				A2(
					...
					mdgriffith$elm_ui$Element$none)),
			u: mdgriffith$elm_ui$Element$Input$labelHidden('Mark (in)complete'),
			aA: elm$core$Basics$always(
				A2(author$project$Main$Check, todo.f, !todo.g))
		});
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
		...
		todo.U ? _List_fromArray(
			[viewEditing]) : _List_fromArray(
			[viewCompleteCheckbox, viewReadonly]));
};
var author$project$Main$viewKeyedEntry = function (todo) {
	return _Utils_Tuple2(
		elm$core$String$fromInt(todo.f),
		A2(mdgriffith$elm_ui$Element$Lazy$lazy, author$project$Main$viewEntry, todo));
};
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											mdgriffith$elm_ui$Element$moveUp(18),
											mdgriffith$elm_ui$Element$Border$width(0),
											mdgriffith$elm_ui$Element$rotate(elm$core$Basics$pi / 2),
											mdgriffith$elm_ui$Element$Font$size(22),
											mdgriffith$elm_ui$Element$Font$center,
											mdgriffith$elm_ui$Element$Font$color(
											checked ? A3(mdgriffith$elm_ui$Element$rgb255, 155, 155, 155) : A3(mdgriffith$elm_ui$Element$rgb255, 230, 230, 230)),
											mdgriffith$elm_ui$Element$paddingEach(
											{q: 10, af: 27, ah: 27, E: 10})
										]),
									mdgriffith$elm_ui$Element$text('❯'));
							},
							u: mdgriffith$elm_ui$Element$Input$labelHidden('Mark all as complete'),
							aA: elm$core$Basics$always(
...
var mdgriffith$elm_ui$Element$Font$hairline = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontWeight, mdgriffith$elm_ui$Internal$Style$classes.dc);
...
var author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$Font$color(
			A4(mdgriffith$elm_ui$Element$rgba255, 175, 47, 47, 0.15))
		]),
	mdgriffith$elm_ui$Element$text('todos'));
...
var author$project$Main$viewInput = function (task) {
	return A2(
		...
		{
			u: mdgriffith$elm_ui$Element$Input$labelHidden('What needs to be done?'),
			aA: author$project$Main$UpdateField,
			bs: elm$core$Maybe$Just(
				A2(
					mdgriffith$elm_ui$Element$Input$placeholder,
					_List_fromArray(
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.cL, mdgriffith$elm_ui$Internal$Style$classes.bX, mdgriffith$elm_ui$Internal$Style$classes.cS]))),
...
var mdgriffith$elm_ui$Element$Font$light = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontWeight, mdgriffith$elm_ui$Internal$Style$classes.c7);
			...
			_List_fromArray(
				[
					...
					[
						...
						mdgriffith$elm_ui$Element$Font$color(
						A3(mdgriffith$elm_ui$Element$rgb255, 77, 77, 77)),
			...
			_List_fromArray(
				[
					...
					A2(
						...
						550,
						A2(mdgriffith$elm_ui$Element$minimum, 230, mdgriffith$elm_ui$Element$fill))),
					mdgriffith$elm_ui$Element$centerX
				]),
			_List_fromArray(
				[
					...
					A3(
						...
						_List_fromArray(
							[
								...
								'innerText',
								elm$json$Json$Encode$string('.todo-entry .destroy {display: none} .todo-entry:hover .destroy {display:flex}'))
							]),
						_List_Nil)),
						...
						[
							...
							_List_fromArray(
								[
									...
									A3(mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)),
									mdgriffith$elm_ui$Element$htmlAttribute(
									A2(elm$html$Html$Attributes$style, 'box-shadow', '0 2px 4px 0 rgba(0, 0, 0, 0.2), 0 25px 50px 0 rgba(0, 0, 0, 0.1)'))
								]),
							_List_fromArray(
								[
									author$project$Main$viewInput(model.t),
									A3(mdgriffith$elm_ui$Element$Lazy$lazy2, author$project$Main$viewEntries, model.S, model.a),
									A3(mdgriffith$elm_ui$Element$Lazy$lazy2, author$project$Main$viewControls, model.S, model.a)
								])),
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		...
		dj: author$project$Main$updateWithStorage,
		dk: function (model) {
			return {
				b1: _List_fromArray(
					[
										...
										return A2(
											...
											function (entries) {
												return elm$json$Json$Decode$succeed(
													{a: entries, t: field, R: uid, S: visibility});
											},
											A2(
																	...
																	return A2(
																		...
																		function (description) {
																			return A2(
																				...
																				function (completed) {
																					return elm$json$Json$Decode$succeed(
																						{g: completed, J: description, U: editing, f: id});
																				},
